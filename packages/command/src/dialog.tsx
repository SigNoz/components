...
function DialogContent({
	...
	const positionClasses =
		position === 'center'
			...
			: position === 'top'
				? 'left-[50%] translate-x-[-50%]' // horizontal centering via Tailwind; top via inline style
				: ''; // custom: expect user-supplied classes in className

	const style = position === 'top' ? { top: `${offset}px` } : undefined;
