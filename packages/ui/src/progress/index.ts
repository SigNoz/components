 ...
 * | Token | Default |
 * |-------|---------|
 * | `--progress-active-animation-duration` | `1.5s` |
 * | `--progress-active-stripe-size` | `1.5rem 1.5rem` |
 * | `--progress-background` | `var(--l3-background)` |
 * | `--progress-border-radius` | `0` |
 * | `--progress-divider-background` | `var(--l1-background)` |
 * | `--progress-divider-width` | `2px` |
 * | `--progress-height` | `4px` |
 ...
 * | `--progress-wrapper-gap` | `var(--spacing-4, 8px)` |
