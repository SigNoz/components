		...
		return (
			...
			>
				...
				{localValues.map((val, index) => (
					<SliderThumb
						// oxlint-disable-next-line react/no-array-index-key -- Thumbs order does not change
					...
					<div className={styles['slider-marks']}>
						{markList.map(({ key, markVal, percent, label, markStyle }) => (
							<span
								...
								// oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- span is intentional to avoid native button styling on slider marks
								role="button"
								tabIndex={0}
