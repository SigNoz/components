...
describe('Textarea', () => {
	...
	it('testId takes precedence over data-testid when both are set', () => {
		render(<Textarea testId="from-testid" data-testid="from-data-testid" />);
		expect(screen.getByTestId('from-testid')).toBeInTheDocument();
