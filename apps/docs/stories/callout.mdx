...
export default function MyComponent() {
	return (
		<Callout type="info" size="medium" title="Important Information">
...
export default function MyComponent() {
	return (
		<Callout type="info" icon={<Star />} title="Featured Item">
...
export default function MyComponent() {
	return (
		<Callout type="info" showIcon title="Expandable Content" action="expandable">
