	...
	render: () => (
		...
		>
				...
				<div style={{ padding: '1.5rem', backgroundColor: 'var(--background)' }}>
					...
					>
						...
						>
							...
							<li>
								• Use useDefaultLayout with groupId for persistent layouts (see Persistent Layout
								story)
							</li>
			...
			<section>
				...
				<PersistentLayoutContent groupId="demo-layout" />
			</section>
		</div>
	),
};
