...
const items: MenuItem[] = [
	{ key: 'view', label: 'View', icon: <Grid3X3 style={{ width: '1rem', height: '1rem' }} /> },
	{ key: 'copy', label: 'Copy link', icon: <Link2 style={{ width: '1rem', height: '1rem' }} /> },
	{ type: 'divider' },
	{
		key: 'delete',
		label: 'Delete',
...
const items: MenuItem[] = [
	{
		...
		rightIcon: <Check style={{ width: '1rem', height: '1rem' }} />,
	},
	{ key: 'copy', label: 'Copy link', icon: <Link2 style={{ width: '1rem', height: '1rem' }} /> },
	{ type: 'divider' },
	{
...
const items: MenuItem[] = [
	{
		...
		children: [
			...
			{ type: 'divider' },
			{
				key: 'logout',
				label: 'Log out',
				icon: <LogOut style={{ width: '1rem', height: '1rem' }} />,
				danger: true,
			},
		],
	},
...
const items: MenuItem[] = [
	{
		...
		icon: <User style={{ width: '1rem', height: '1rem' }} />,
		children: [
			{ key: 'email', label: 'Email', icon: <Copy style={{ width: '1rem', height: '1rem' }} /> },
			{
				key: 'message',
				label: 'Message',
...
const allItems: MenuItem[] = [
	{ key: 'profile', label: 'Profile', icon: <User style={{ width: '1rem', height: '1rem' }} /> },
	{
		key: 'settings',
		label: 'Settings',
		icon: <Settings style={{ width: '1rem', height: '1rem' }} />,
		...
		<DropdownMenuSimple
			menu={{
				...
				search: {
					...
					searchIcon: <Search style={{ width: '1rem', height: '1rem' }} />,
