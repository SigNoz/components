...
import {
	...
	CommandSeparator,
	CommandShortcut,
} from '@signozhq/components/command';
...
const examples = [
	`import { Command, CommandInput, CommandList, CommandItem } from '@signozhq/components/command';
...
const docs = generateDocs({
	packageName: '@signozhq/components/command',
	description:
