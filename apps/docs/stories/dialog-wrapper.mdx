...
export default function MyComponent() {
	return (
		<DialogWrapper title="Edit Details" trigger={<Button variant="solid">Open Dialog</Button>}>
...
<DialogWrapper title="No close button" showCloseButton={false} trigger={<Button>Open</Button>}>
